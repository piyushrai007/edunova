...
function BlogList() {
  ...
  useEffect(() => {
    axios.get('https://backend-nfkn.onrender.com/api/blogs/')
      .then(response => {
      ...
      <BentoGrid className="max-w-4xl mx-auto">
        {blogs.map((blog, i) => (
          <BentoGridItem
            ...
            header={ <img
              src={blog.title_image ? blog.title_image : "https://cdn.activestate.com/wp-content/uploads/2014/07/best-coding-fonts-blog-hero.jpg"}
              alt={blog.title}
            />}
